...
export class Signup extends Component {
    ...
    handleSubmit = sub => {
        ...
        if ( this.state.type === "" ) {
            ...
            //     axios
            //         .post( BACKEND_URL + '/restaurant/signup', this.state )
            //         .then( ( response ) => {
                            ...
                            <div className="col-12">
                                ...
                                <form onSubmit={ this.handleSubmit } style={ { "margin": "10px" } } id="Signup">
                                    <div className="role" >
                                        ...
                                        <input type="radio" style={ { "margin": "0 5px" } } id='radio-b2' name="type" value='restaurant' onChange={ this.handleInputChange }
                                        />
                                    ...
                                    <div className="form-group">
                                        { this.state.type === 'restaurant' ? <input type="text" className="form-control" name="location" required
